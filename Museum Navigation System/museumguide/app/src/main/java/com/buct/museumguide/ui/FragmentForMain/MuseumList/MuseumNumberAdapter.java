...
public class MuseumNumberAdapter extends RecyclerView.Adapter<MuseumNumberAdapter.ViewHolder> {
    private Context context;
    private List<Museum> mMuseumList;
    private MuseumNumberAdapter.OnItemClickListener onItemClickListener;
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view){
            ...
            museumNumber = view.findViewById(R.id.museum_collection_num);
    ...
    public MuseumNumberAdapter(List<Museum> museumList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.museum_num_items,parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.museumNumber.setText(museum.getCollection_num());
    ...
    public void setOnItemClickListener(MuseumNumberAdapter.OnItemClickListener listener){
