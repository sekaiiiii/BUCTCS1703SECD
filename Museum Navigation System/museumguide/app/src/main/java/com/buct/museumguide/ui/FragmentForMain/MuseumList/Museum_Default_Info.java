...
public class Museum_Default_Info implements Serializable {
    private int status;
    private Museum_Info_Full.museuminfo data;
    public static class museuminfo implements Serializable {
        private String msg;
        private ArrayList<Museum_Info_Full.museuminfo.realdata> museum_list;
        ...
        public ArrayList<Museum_Info_Full.museuminfo.realdata> getMuseum_list() {
            return museum_list;
        }

        public void setMuseum_list(ArrayList<Museum_Info_Full.museuminfo.realdata> museum_list) {
            this.museum_list = museum_list;
        }
    }

    public void setData(Museum_Info_Full.museuminfo data) {
        this.data = data;
    }
    ...
    public Museum_Info_Full.museuminfo getData() {
        return data;
    }
}
